...
public class AnimatorAction : ActionMethod {
    ...
    private string TargetName {
        get { return (this.AnimatorsMode != AnimatorAction.FindAnimatorsMode.SpecifyAnimators) ? ((!this.Target) ? "unkown" : this.Target.name) : ((this.Animators.Length <= 0 || !this.Animators[0]) ? "unkown" : this.Animators[0].name); }
    }
