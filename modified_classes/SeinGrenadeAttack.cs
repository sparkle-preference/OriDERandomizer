...
public class SeinGrenadeAttack : CharacterState, ISeinReceiver {
    private bool IsGrabbingWall {
        get { return this.m_sein.Controller.IsGrabbingWall; }
    }

    private bool IsInAir {
        get { return !this.m_isAiming; }
    }
    ...
    private bool HasEnoughEnergy {
        get { return this.m_sein.Energy.CanAfford(this.EnergyCostFinal); }
    }
    ...
    private Vector3 GrenadeSpawnPosition {
        get { return this.m_sein.Position; }
    }
    ...
    public bool CanAim {
        get { return !this.m_sein.PlatformBehaviour.PlatformMovement.MovingHorizontally && (this.m_sein.IsOnGround || this.IsGrabbingWall); }
    }
    ...
    public float GrenadeGravity {
        get { return this.Trajectory.Gravity; }
    }
