...
public class SeinSoulFlame : CharacterState, ISeinReceiver {
    ...
    public bool SoulFlameExists {
        get { return this.m_checkpointMarkerGameObject; }
    }

    public Vector3 SoulFlamePosition {
        get { return this.m_checkpointMarkerGameObject.transform.position; }
    }
    ...
    public bool InsideCheckpointMarker {
        get { return this.m_soulFlame && this.m_soulFlame.IsInside; }
    }
    ...
    public float BarValue {
        get { return (1f - this.CooldownRemaining) * (1f - this.m_holdDownTime); }
    }

    public float CooldownRemaining {
        get { return this.m_cooldownRemaining; }
    }

    public bool ShowFlameOnUI {
        get { return Mathf.Approximately(this.BarValue, 1f); }
    }
    ...
    public bool CanAffordSoulFlame {
        get { return this.m_sein.Energy.CanAfford(this.SoulFlameCost); }
    }

    public bool AllowedToAccessSkillTree {
        get { return this.m_sein.Level.Current > 0 && this.IsSafeToCastSoulFlame == SeinSoulFlame.SoulFlamePlacementSafety.Safe; }
    }

    public bool PlayerCouldSoulFlame {
        get { return Characters.Sein.Controller.CanMove && !this.m_sein.Controller.IsSwimming && !UI.Fader.IsFadingInOrStay() && !SeinAbilityRestrictZone.IsInside(SeinAbilityRestrictZoneMode.AllAbilities) && !this.LockSoulFlame; }
    }
