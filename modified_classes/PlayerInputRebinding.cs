...
public class PlayerInputRebinding {
    ...
    private static string KeyRebindingFile {
        get { return Path.Combine(OutputFolder.PlayerDataFolderPath, PlayerInputRebinding.keyRebindingFileName); }
    }
    ...
    private static string ControllerRemappingFile {
        get { return Path.Combine(OutputFolder.PlayerDataFolderPath, PlayerInputRebinding.controllerRebindingFileName); }
    }
        ...
        try {
            using (StreamReader streamReader = new StreamReader(new FileStream(PlayerInputRebinding.ControllerRemappingFile, FileMode.Open))) {
                ...
                if (flag) {
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[0] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[1] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[2] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[3] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[4] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[5] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[6] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[7] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[8] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[9] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[12] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
                    ...
                    PlayerInputRebinding.m_controllerButtonRemappings[13] = int.Parse(
                        streamReader.ReadLine().Split(
                            new string[] {
                                ": "
                            },
    ...
    public static string ControllerRebindingFile {
        get { return Path.Combine(OutputFolder.PlayerDataFolderPath, PlayerInputRebinding.controllerInputRebindingsFileName); }
    }
