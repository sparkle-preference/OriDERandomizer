...
public class SeinDoubleJump : CharacterState, ISeinReceiver {
    ...
    public SeinJump Jump {
        get { return this.Sein.Abilities.Jump; }
    }

    public bool CanDoubleJump {
        get { return base.enabled && !this.PlatformMovement.IsOnGround && this.m_numberOfJumpsAvailable != 0 && this.m_remainingLockTime <= 0f && !SeinAbilityRestrictZone.IsInside(SeinAbilityRestrictZoneMode.AllAbilities); }
    }
    ...
    public void PerformDoubleJump() {
        ...
        this.m_doubleJumpSound = Sound.Play(this.DoubleJumpSound.GetSound(null), this.Sein.PlatformBehaviour.PlatformMovement.Position, delegate { this.m_doubleJumpSound = null; });
