...
public class SeinJump : CharacterState, ISeinReceiver {
    ...
    public bool CanJump {
        get { return base.enabled && this.Sein.PlatformBehaviour.PlatformMovement.LocalSpeedY <= 0.0001f && this.m_timeWeCanJumpRemaining > 0f && !this.Sein.PlatformBehaviour.PlatformMovement.Ceiling.IsOn && !SeinAbilityRestrictZone.IsInside(SeinAbilityRestrictZoneMode.AllAbilities); }
    }
    ...
    public CharacterSpriteMirror CharacterSpriteMirror {
        get { return this.Sein.PlatformBehaviour.Visuals.SpriteMirror; }
    }

    public bool HasSharplyTurnedAround {
        get { return (this.m_timeSinceMovingRight > 0f && this.m_timeSinceMovingRight < 0.2f && this.PlatformMovement.LocalSpeedX < 0f) || (this.m_timeSinceMovingLeft > 0f && this.m_timeSinceMovingLeft < 0.2f && this.PlatformMovement.LocalSpeedX > 0f); }
    }
