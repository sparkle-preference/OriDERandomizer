...
public class Entity : SaveSerialize, IRespawnReciever, IFrustumOptimizable, ISuspendable {
    ...
    public bool IsInWater {
        get { return WaterZone.PositionInWater(this.Position); }
    }
    ...
    public bool PlayerIsToLeft {
        get { return this.PositionToPlayerPosition.x < 0f; }
    }
    ...
    public Quaternion Rotation {
        get { return base.transform.rotation; }
        set { base.transform.rotation = value; }
    }

    public Vector3 PositionToPlayerPosition {
        get { return base.transform.InverseTransformDirection(this.PlayerPosition - this.Position); }
    }

    public Vector3 StartPositionToPlayerPosition {
        get { return this.PlayerPosition - this.StartPosition; }
    }

    public bool LeftOfStartPosition {
        get { return this.StartPositionToPlayerPosition.x < 0f; }
    }

    public Vector3 PositionToStartPosition {
        get { return this.StartPosition - this.Position; }
    }
    ...
    public void RegisterRespawnDelegate(Action onRespawn) {
        this.DamageReciever.OnDeathEvent.Add(delegate(Damage a) { onRespawn(); });
    }
