...
public class AreaMapCanvas : MonoBehaviour {
    ...
    public Texture WorldMapTexture {
        get { return this.Area.WorldMapTexture; }
    }

    public Bounds Bounds {
        get { return this.Area.Bounds; }
    }

    public CageStructureTool CageStructureTool {
        get { return this.Area.CageStructureTool; }
    }

    public Vector2 WorldMapTextureSize {
        get { return new Vector2((float)this.WorldMapTexture.width, (float)this.WorldMapTexture.height); }
    }
