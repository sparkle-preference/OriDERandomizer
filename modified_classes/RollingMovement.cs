...
public class RollingMovement : SaveSerialize, ISuspendable {
    ...
    public float SpeedX {
        get { return this.Speed.x; }
        set { this.Speed.x = value; }
    }

    public float GroundAngle {
        get { return 57.29578f * Mathf.Atan2(-this.GroundNormal.x, this.GroundNormal.y); }
    }
    ...
    public Vector3 GroundBinormal {
        get { return Vector3.Cross(this.GroundNormal, Vector3.forward); }
    }
