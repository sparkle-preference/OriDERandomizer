...
public class SeinHealthController : SaveSerialize, ISeinReceiver {
    ...
    public float VisualMinAmountNormalized {
        get { return this.VisualMinAmount / (float)this.MaxHealth; }
    }

    public float VisualMaxAmountNormalized {
        get { return this.VisualMaxAmount / (float)this.MaxHealth; }
    }

    public int HealthUpgradesCollected {
        get { return this.MaxHealth / 4 - 3; }
    }
    ...
    public bool IsFull {
        get { return this.Amount == (float)this.MaxHealth; }
    }
