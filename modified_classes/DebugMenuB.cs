...
public class DebugMenuB : SaveSerialize {
    ...
    private void BuildMenu() {
        ...
        list.Add(new BoolDebugMenuItem("Unlock Cutscenes", () => DebugMenuB.UnlockAllCutscenes, delegate(bool value) { DebugMenuB.UnlockAllCutscenes = value; }));
        list.Add(
        ...
        foreach (string text in this.ImportantLevelsNames) {
            ...
            if (flag) {
                list3.Add(
                    new ActionDebugMenuItem(text, new Func<bool>(this.GoToScene)) {
