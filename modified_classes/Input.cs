...
namespace Core {
    public class Input {
        ...
        public static Vector2 Axis {
            get { return new Vector2(Input.Horizontal, Input.Vertical); }
        }

        public static Vector2 AnalogAxisLeft {
            get { return new Vector2(Input.HorizontalAnalogLeft, Input.VerticalAnalogLeft); }
        }

        public static Vector2 AnalogAxisRight {
            get { return new Vector2(Input.HorizontalAnalogRight, Input.VerticalAnalogRight); }
        }

        public static Vector2 DigiPadAxis {
            get { return new Vector2((float)Input.HorizontalDigiPad, (float)Input.VerticalDigiPad); }
        }
        ...
        public class InputButtonProcessor {
            ...
            public bool OnPressed {
                get { return this.IsPressed && !this.WasPressed; }
            }

            public bool OnPressedNotUsed {
                get { return this.IsPressed && !this.WasPressed && !this.Used; }
            }
