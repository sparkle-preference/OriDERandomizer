...
public class MessageBox : MonoBehaviour {
    ...
    public EmotionType CurrentEmotion {
        get { return this.m_currentMessage.Emotion; }
    }

    public SoundProvider CurrentMessageSound {
        get { return this.m_currentMessage.Sound; }
    }
    ...
    public bool IsLastMessage {
        get { return this.m_messageDescriptors == null || this.MessageIndex == this.m_messageDescriptors.Length - 1; }
    }

    public bool FinishedWriting {
        get { return this.WriteOutTextBox == null || this.WriteOutTextBox.AtEnd; }
    }
