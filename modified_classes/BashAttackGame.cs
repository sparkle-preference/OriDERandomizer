...
internal class BashAttackGame : Suspendable, IPooled {
    ...
    private void UpdatePlayingState() {
        if (this.m_nextBashLoopPlayedTime <= this.m_stateCurrentTime) {
            this.m_bashLoopingAudioSource = Sound.Play((!Characters.Sein.PlayerAbilities.BashBuff.HasAbility) ? Characters.Sein.Abilities.Bash.BashLoopSound.GetSound(null) : Characters.Sein.Abilities.Bash.UpgradedBashLoopSound.GetSound(null), base.transform.position, delegate() { this.m_bashLoopingAudioSource = null; });
