...
public class SeinSwimming : CharacterState, ISeinReceiver {
    ...
    public bool IsUpsideDown {
        get { return Vector3.Dot(MoonMath.Angle.VectorFromAngle(this.SwimAngle), (!this.m_sein.Controller.FaceLeft) ? Vector3.left : Vector3.right) > Mathf.Cos(0.87266463f); }
    }

    public float RemainingBreath { get; set; }

    public bool HasUnlimitedBreathingUnderwater {
        get { return this.m_sein.PlayerAbilities.WaterBreath.HasAbility; }
    }
    ...
    public CharacterLeftRightMovement LeftRightMovement {
        get { return this.m_sein.PlatformBehaviour.LeftRightMovement; }
    }

    public CharacterGravity Gravity {
        get { return this.m_sein.PlatformBehaviour.Gravity; }
    }

    public bool IsSwimming {
        get { return this.CurrentState != SeinSwimming.State.OutOfWater; }
    }

    private float WaterSurfacePositionY {
        get { return this.m_currentWater.Bounds.yMax; }
    }
    ...
    public bool IsUnderwater {
        get { return this.CurrentState == SeinSwimming.State.SwimMovingUnderwater || this.CurrentState == SeinSwimming.State.SwimIdleUnderwater; }
    }
