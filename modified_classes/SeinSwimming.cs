...
public class SeinSwimming : CharacterState, ISeinReceiver {
    ...
    public bool HasUnlimitedBreathingUnderwater {
        get { return m_sein.PlayerAbilities.WaterBreath.HasAbility; }
    }
    ...
    public bool IsSwimming {
        get { return CurrentState != State.OutOfWater; }
    }

    private float WaterSurfacePositionY {
        get { return m_currentWater.Bounds.yMax; }
    }
    ...
    public bool IsUnderwater {
        get { return CurrentState == State.SwimMovingUnderwater || CurrentState == State.SwimIdleUnderwater; }
    }
