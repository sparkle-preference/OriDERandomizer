...
public class SkillTreeManager : MenuScreen {
    public bool AllLanesFull {
        get { return this.EnergyLane.HasAllSkills && this.UtilityLane.HasAllSkills && this.CombatLane.HasAllSkills; }
    }
    ...
    public MessageDescriptor AbilityMastered {
        get { return new MessageDescriptor("$" + this.AbilityMasteredMessageProvider + "$"); }
    }
