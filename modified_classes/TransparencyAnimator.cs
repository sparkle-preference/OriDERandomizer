...
public class TransparencyAnimator : BaseAnimator {
    ...
    private bool UseSharedMaterial {
        get { return (this.IsInScene && !this.m_forceUseRendererMaterial) || !Application.isPlaying; }
    }
    ...
    public float FinalOpacity {
        get { return this.m_opacity * this.m_parentOpacity; }
    }

    public override float Duration {
        get { return base.AnimationCurveTimeToTime(this.AnimationCurve.CurveDuration()); }
    }
    ...
    public override bool IsLooping {
        get { return this.AnimationCurve.postWrapMode != WrapMode.ClampForever; }
    }
    ...
    [PooledSafe] private readonly List<TransparencyAnimator.RendererData> m_rendererData = new List<TransparencyAnimator.RendererData>(4);
