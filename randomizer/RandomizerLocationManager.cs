...
public class RandomizerLocationManager {
    ...
    public static bool IsDoorOpen(MoonGuid doorGuid) {
        return 1 == (1 & (Randomizer.Inventory.GetRandomizerItem(72) >> KeystoneDoors[doorGuid].Index));
    }
