...
public static class RandomizerDataMaps
{
	...
	public static void LoadValleyData()
	{
		...
		{
			new MoonGuid(-1568394388, 1274998947, -983947605, -1805628374),
			new byte[]
			{
				1,
				154,
		...
		Randomizer.ValleyStompDoorData.Add(new object[]
		{
			new MoonGuid(1993321239, 1101505207, -1185440599, 1240321723),
			new byte[]
			{
				136,
				118,
		...
		ArrayList valleyStompDoorData = Randomizer.ValleyStompDoorData;
		object[] array3 = new object[2];
		array3[0] = new MoonGuid(2060985135, 1082697961, -112761206, 123288777);
		int num2 = 1;
		byte[] array4 = new byte[256];
		array4[3] = 64;
		array4[4] = 1;
		array3[num2] = array4;
		valleyStompDoorData.Add(array3);
	}
}
