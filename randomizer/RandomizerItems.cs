...
public static class RandomizerItems {
    ...
    private static readonly Dictionary<string, string> UpgradeNames = new Dictionary<string, string> {
        ...
        { "216", "Spirit Potency" }, { "217", "Life Regen (Ability)" }, { "218", "Energy Regen (Ability)" },
        ...
        { "246", "Remove Spirit Potency" }, { "247", "Remove Life Regen (Ability)" }, { "248", "Remove Energy Regen (Ability)" },
