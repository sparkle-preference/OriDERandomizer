public class RandoOptionsScreen : CustomSettingsScreen {
    public override void InitScreen() {
        AddSlider(RandomizerSettings.Customization.TouchedVisibility, 0f, 1f, 0.05f, "How much of a pickup that has nothing left to give is still drawn on the map. All the way down hides them.");
        AddSlider(RandomizerSettings.Customization.MapWarpHold, 0.1f, 3f, 0.1f, "How long [[Map Warp]] must be held on a Spirit Well in the map before it warps you there.");
